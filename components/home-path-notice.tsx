...
export function HomePathNotice({ regularRank, pathRank }: { regularRank: string; pathRank: string }) {
  ...
  return (
    <section className="relative rounded-3xl border border-amber-400/30 bg-amber-400/10 p-5 pr-14 shadow-glow">
      ...
      <p className="mt-2 text-sm leading-6 text-amber-100/80">Your regular rank is {regularRank}, but your seasonal path is only {pathRank}. Complete the path maps until you reach your current rank.</p>

...
export function RankingSystemControls({ initialConfig, initialRows, initialSummary }: Props) {
  ...
  return <div className="space-y-6">
    <section className="rounded-3xl border border-white/10 bg-surface/95 p-6 shadow-glow">
      ...
      <p className="mt-2 max-w-4xl text-sm leading-6 text-muted">Ranks are rebuilt from eligible map passes. Rhythia RP, Rhythia global rank, rank-local point locks, and top-play weighting do not seed or cap progression. RHP uses the strongest completed camera mode for each map; RPL, RPV and RPS remain separate cumulative mode totals.</p>

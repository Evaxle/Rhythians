      ...
      <div className="mx-auto flex max-w-[1600px] items-center gap-2 px-3 py-3 sm:gap-4 sm:px-5 sm:py-4 lg:px-6 2xl:gap-5 2xl:px-8">
        ...
        <div className="ml-auto flex shrink-0 items-center gap-2 sm:gap-2.5">
          <details className="relative 2xl:hidden">
            ...
            <nav className="absolute right-0 z-50 mt-2 grid w-56 gap-1 rounded-2xl border border-border bg-surface p-2 shadow-xl">
              <Link href="/" className="rounded-xl px-3 py-2 text-sm text-muted transition hover:bg-white/5 hover:text-white">Home</Link>
              <Link href="/daily" className="rounded-xl px-3 py-2 text-sm text-muted transition hover:bg-white/5 hover:text-white">Daily</Link>
              <Link href="/maps" className="rounded-xl px-3 py-2 text-sm text-muted transition hover:bg-white/5 hover:text-white">Maps</Link>
              <Link href="/categories?tab=challenge" className="rounded-xl px-3 py-2 text-sm text-muted transition hover:bg-white/5 hover:text-white">Challenge</Link>
              <Link href="/leaderboards" className="rounded-xl px-3 py-2 text-sm text-muted transition hover:bg-white/5 hover:text-white">Leaderboards</Link>
              <Link href="/wiki" className="rounded-xl px-3 py-2 text-sm text-muted transition hover:bg-white/5 hover:text-white">Wiki</Link>
              <Link href="/clips" className="rounded-xl px-3 py-2 text-sm text-muted transition hover:bg-white/5 hover:text-white">Clips</Link>
              <Link href="/rules" className="rounded-xl px-3 py-2 text-sm text-muted transition hover:bg-white/5 hover:text-white">Rules</Link>
              <Link href="/community" className="rounded-xl px-3 py-2 text-sm text-muted transition hover:bg-white/5 hover:text-white">Community</Link>
              {user && <Link href="/messages" className="rounded-xl px-3 py-2 text-sm text-muted transition hover:bg-white/5 hover:text-white">Messages</Link>}
              {hasApprovalAccess && <Link href="/approval" className="rounded-xl px-3 py-2 text-sm text-accent transition hover:bg-white/5 hover:text-white">Review</Link>}
              {isAdmin && <Link href="/admin" className="rounded-xl px-3 py-2 text-sm font-semibold text-accent transition hover:bg-white/5 hover:text-white">Admin</Link>}
            </nav>
          </details>

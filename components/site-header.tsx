...
const links = [
  ["/", "Home"], ["/daily", "Daily"], ["/path", "Path"], ["/maps", "Maps"], ["/categories?tab=challenge", "Challenge"], ["/battles", "Battles"], ["/online", "Online"], ["/wiki", "Wiki"], ["/settings", "Settings"], ["/leaderboards", "Leaderboards"], ["/clips", "Clips"], ["/rules", "Rules"], ["/community", "Community"]
] as const;

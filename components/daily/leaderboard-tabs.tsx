...
export function LeaderboardTabs({
  ...
  return (
    <div className="space-y-6">
      ...
      {tab === "daily" ? <DailyLeaderboard leaderboards={dailyLeaderboards} currentUserId={currentUserId} /> : tab === "maps" ? <ChallengeLeaderboard leaderboards={challengeLeaderboards} currentUserId={currentUserId} /> : <ChallengeLevelLeaderboard rows={challengeLevelLeaderboard} currentUserId={currentUserId} />}
    </div>
  );
}

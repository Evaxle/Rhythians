    ...
    <section className="rounded-3xl border border-border bg-surface/95 p-6 shadow-glow">
      ...
      <div className="mt-5 flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex shrink-0 flex-col gap-2 sm:items-end">
          ...
          <Link href="/daily" className="inline-flex items-center justify-center gap-2 rounded-full border border-border bg-white/5 px-4 py-2 text-sm font-semibold text-white transition hover:border-accent/40">View daily <ArrowRight size={15} /></Link>
        </div>
      </div>
    </section>
  );

      ...
      {open && (
        <div className="animate-rise-in absolute right-0 z-30 mt-2 w-56 rounded-2xl border border-border bg-surface p-2 shadow-glow">
          ...
          <Link
            ...
            className="mt-1 block rounded-xl px-3 py-2 text-sm text-muted transition hover:bg-white/5 hover:text-white"
          >
            View profile
          </Link>
          <Link
            href="/rhythia/request"
            className="block rounded-xl px-3 py-2 text-sm text-muted transition hover:bg-white/5 hover:text-white"
          >
            Rhythia verification
          </Link>
          <Link
            href="/messages"
            className="block rounded-xl px-3 py-2 text-sm text-muted transition hover:bg-white/5 hover:text-white"
          ...
          <a
            ...
            className="block rounded-xl px-3 py-2 text-sm text-red-300 transition hover:bg-red-500/10 hover:text-red-200"
          >
            Log out
          </a>
        </div>

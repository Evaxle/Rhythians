...
import ChallengeMapSubmitForm from "@/components/maps/challenge-map-submit-form";
...
export default async function ChallengeMapSubmitPage() {
  ...
  return <div className="mx-auto max-w-3xl space-y-8"><section className="space-y-2"><p className="flex items-center gap-2 text-sm uppercase tracking-[0.24em] text-accent"><Swords size={16} /> Submit a challenge map</p><h1 className="text-3xl font-semibold text-white">Add a challenge map</h1><p className="text-sm leading-7 text-muted">Challenge maps are placed into the Main Challenge or a skill category by reviewers. They do not award RHP.</p></section><ChallengeMapSubmitForm /></div>;
}

...
export default async function LeaderboardsPage() {
  ...
  const userRank = getRankInfo((await prisma.user.findUnique({ where: { id: user.id }, select: { rhp: true } }))?.rhp ?? user.rhp).index;

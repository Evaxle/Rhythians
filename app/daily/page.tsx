...
import { Link2, LogIn, Sparkles } from "lucide-react";
      ...
      <div className="mx-auto max-w-2xl space-y-6">
        <section className="rounded-3xl border border-border bg-surface/95 p-10 text-center shadow-glow">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-muted">
            The daily map, leaderboards, and Rhythian Points are only available to members who link their Rhythia
            account. Sign in to get started.
          </p>
    ...
    return (
      <div className="mx-auto max-w-2xl space-y-6">
        <section className="rounded-3xl border border-border bg-surface/95 p-10 text-center shadow-glow">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-muted">
            To access the daily map and leaderboards you first need to link your Rhythia profile. Visit your profile
            page and connect your account.
          </p>

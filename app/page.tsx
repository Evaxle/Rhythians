...
function getRecentUpdates(): RecentUpdate[] {
  return [
    { id: "ranking-v2", title: "Competitive ranking rebuilt with balanced RHP, RPL, RPS, RPV placement and battle seeding", label: "Ranking", href: "/wiki/ranking", updatedAt: new Date("2026-09-08T23:00:00-04:00") },

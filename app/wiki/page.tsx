...
export default function WikiPage() {
  return <div className="ui-page space-y-7"><section className="rounded-[2rem] border border-white/10 bg-surface/95 p-7 shadow-glow sm:p-8"><p className="text-xs font-bold uppercase tracking-[0.24em] text-accent">Rhythians Wiki</p><h1 className="mt-2 text-3xl font-semibold tracking-tight text-white">How Rhythians works</h1><p className="mt-3 max-w-3xl text-sm leading-7 text-muted">A practical guide to ranking, maps, challenges, battles, tournaments, and the game systems connected to Rhythians.</p></section>

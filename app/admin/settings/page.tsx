...
export default function AdminSettingsPage() {
  ...
  return <div className="space-y-6">
    <div className="rounded-3xl border border-border bg-surface/95 p-8 shadow-glow"><h1 className="text-3xl font-semibold text-white">System settings</h1><p className="mt-3 text-sm leading-7 text-muted">Configure branding, feature flags, integrations, and player settings showcases.</p></div>
    <section className="rounded-3xl border border-border bg-surface/95 p-7 shadow-glow">
      <p className="text-xs font-bold uppercase tracking-[0.3em] text-accent">Community Settings Showcase</p><h2 className="mt-2 text-2xl font-black text-white">{editingId ? "Edit community settings" : "Add community settings"}</h2><p className="mt-2 text-sm text-muted">Upload an RHS file and use either a video file or TikTok, YouTube, Twitch, or Medal.tv URL for the gameplay preview.</p>

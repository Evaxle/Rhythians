      ...
      <aside className="rounded-3xl border border-border bg-surface/95 p-6 shadow-glow">
        <div className="space-y-6">
          <div>
            ...
            <h2 className="mt-3 text-xl font-semibold text-white">Content & moderation</h2>
          </div>
          <nav className="space-y-2 text-sm text-muted">
            ...
            <div className="mt-4 border-t border-border pt-4">
              <p className="mb-2 uppercase tracking-[0.24em] text-[11px] text-accent">Clips</p>
              <Link href="/admin/clips" className="block rounded-2xl px-3 py-2 transition hover:bg-white/5">Pending</Link>
              <Link href="/admin/clips/manage" className="block rounded-2xl px-3 py-2 transition hover:bg-white/5">Manage clips</Link>
              <Link href="/admin/featured-clips" className="block rounded-2xl px-3 py-2 transition hover:bg-white/5">Featured</Link>
            </div>
            <div className="mt-4 border-t border-border pt-4">
            ...
            <div className="mt-4 border-t border-border pt-4">
              ...
              <Link href="/admin/discord" className="block rounded-2xl px-3 py-2 transition hover:bg-white/5">Integration</Link>
            </div>
            <div className="mt-4 border-t border-border pt-4">
              <p className="mb-2 uppercase tracking-[0.24em] text-[11px] text-accent">System</p>
              <Link href="/admin/settings" className="block rounded-2xl px-3 py-2 transition hover:bg-white/5">Settings</Link>
            </div>
          </nav>
        </div>
      </aside>

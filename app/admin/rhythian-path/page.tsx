          ...
          return (
            <article key={rank.name} className="rounded-3xl border border-border bg-surface/95 p-6 shadow-glow">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-xs uppercase tracking-[0.25em] text-muted">Path rank {rank.index + 1}</p>
                  <h2 className="mt-2 text-2xl font-semibold" style={{ color: rank.color }}>{rank.name}</h2>
                </div>

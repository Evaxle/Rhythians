  ...
  return (
    <div className="mx-auto grid max-w-4xl gap-6 md:grid-cols-2">
      <section className="rounded-3xl border border-border bg-surface/95 p-8 shadow-glow">
        ...
        <p className="mt-3 text-sm leading-7 text-muted">Sign in with your Discord account.</p>
        <a href="/api/auth/login" className="mt-6 inline-flex w-full items-center justify-center rounded-full bg-[#5865F2] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#4752c4]">
      ...
      <section className="rounded-3xl border border-border bg-surface/95 p-8 shadow-glow">
        ...
        <p className="mt-3 text-sm leading-7 text-muted">Use your username and password.</p>
        <div className="mt-6">

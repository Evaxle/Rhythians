      ...
      {fullUser.rhythiaProfile && (
        <section className="rounded-3xl border border-border bg-surface/95 p-8 shadow-glow">
          ...
          <p className="mt-2 text-sm leading-7 text-muted">
            Your past Rhythia scores are imported automatically when you link your account. Only maps inside your
            current rank&apos;s rating range award RHP. If you&apos;ve played more ranked maps since then, run the scan
            again to claim the RHP for any new completions.
          </p>

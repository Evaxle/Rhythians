...
import { ProfileTagPins } from "@/components/profile-tag-pins";
import { getPinnedTagSlugs } from "@/lib/profile-tags";
...
export default async function SettingsPage() {
  ...
  const pinnedTagSlugs = await getPinnedTagSlugs(fullUser.id);

...
export async function GET(request: Request) {
  ...
  return NextResponse.json({
    user: {
      ...
      rhythiaProfile: user.rhythiaProfile
        ? {
            profileId: user.rhythiaProfile.profileId,
            profileUrl: user.rhythiaProfile.profileUrl,
            username: user.rhythiaProfile.username,
            country: user.rhythiaProfile.country,
            flag: user.rhythiaProfile.flag,
            globalRank: user.rhythiaProfile.globalRank,
            countryRank: user.rhythiaProfile.countryRank,
            rhythmPoints: user.rhythiaProfile.rhythmPoints,
            isOnline: user.rhythiaProfile.isOnline,
            lastActiveAt: user.rhythiaProfile.lastActiveAt?.toISOString() ?? null,
            syncedAt: user.rhythiaProfile.syncedAt.toISOString(),
          }
        : null,
      stats: {
        clips: user._count.clips,
        comments: user._count.comments,
        messages: user._count.messagesSent,
        reportsFiled: user._count.reports,
        warnings: user._count.warnings,
      },
      ranked: {
        rhp: user.rhp,
        avgMapRating: user.avgMapRating,
        scoreImportDone: user.scoreImportDone,
        dailyStreak: user.dailyStreak,
        lastDailyBeatAt: user.lastDailyBeatAt?.toISOString() ?? null,
        lastRhythiaRpCheckAt: user.lastRhythiaRpCheckAt?.toISOString() ?? null,
        rhythiaVerified: user.rhythiaVerified,
        completions: user._count.challengeCompletions,
        dailyBeats: user._count.dailyMapBeats,
        rhpTransactions: user._count.rhpTransactions,
      },
      moderation,
    },
  });

...
export async function POST(request: Request) {
  ...
  return NextResponse.json({ ok: true, duplicate: result.duplicate, counted: result.counted, map: { id: map.id, title: map.title, rating }, points: result.points, rhp: result.rhp, gameVersion: gameVersion || null, integrationVersion: integrationVersion || null });
}

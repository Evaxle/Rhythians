...
export default async function ProfilePage({ params }: Props) {
  ...
  return (
    <div className="space-y-8">
      ...
      {isOwnProfile && <ProfileTagEditor tags={user.userTags.map((entry) => ({ id: entry.tagId, name: entry.tag.name, slug: entry.tag.slug }))} selected={selectedTags.map((entry) => entry.tagId)} />}
